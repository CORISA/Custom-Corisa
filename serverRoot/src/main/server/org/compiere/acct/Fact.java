...
public final class Fact
{
	...
	//	log.fine("createLine - " + account	+ " - Dr=" + debitAmt + ", Cr=" + creditAmt);
		...
		if (docLine == null && m_doc != null)
			if (m_doc.getC_Charge_ID()!=0)
				line.set_CustomColumn("C_Charge_ID",m_doc.getC_Charge_ID());
	...
	//	log.fine("getSourceBalance - " + result.toString());
		...
		/* 04-05-2009. BUG007:
		 * SE COMENTA Y SE A�ADE ESTA LINEA DE CODIGO
		 * PARA MODIFICAR LA ESCALA DE REDONDEO
		 * PARA NO DEJAR FALSOS ASIENTOS DESCUADRADOS
		 * return result;
		*/
