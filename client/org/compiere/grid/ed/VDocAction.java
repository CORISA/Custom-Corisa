...
import org.custom.model.X_CUST_LoadOrder;
import org.custom.model.X_CUST_RecordWeight;
	...
	implements ActionListener
{
	...
	private void dynInit(int Record_ID)
	{
		...
		else if (DocStatus.equals(org.compiere.vos.DocActionConstants.STATUS_Completed))
		{
			/**
			 * Carlos Parada
			 * Inactive Close Document for Load Order and Record Weight
			 */
			if (m_AD_Table_ID == X_CUST_LoadOrder.Table_ID || m_AD_Table_ID == X_CUST_RecordWeight.Table_ID)
				;
			else
		 ...
		 */
		/**
		 * Cambiado por Carlos Parada 08/10/2012
		 * Se coloco igual que en Adempiere
		 */
		/**
		...
		**/
		else if (m_AD_Table_ID == MCash.Table_ID)
		{
			//	Complete                    ..  CO
			if (DocStatus.equals(org.compiere.vos.DocActionConstants.STATUS_Completed))
			{
		 ...
		 * @date 19/10/2012
		 * Se Agrega Orden de Carga y Registro de Peso
		 */
		else if (m_AD_Table_ID == X_CUST_LoadOrder.Table_ID || m_AD_Table_ID == X_CUST_RecordWeight.Table_ID)
		{
			//	Complete                    ..  CO
			if (DocStatus.equals(org.compiere.vos.DocActionConstants.STATUS_Completed))
			{
